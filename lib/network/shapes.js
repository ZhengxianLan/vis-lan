...
if (typeof CanvasRenderingContext2D !== 'undefined') {
  ...
  CanvasRenderingContext2D.prototype.arrowEndpoint = function (x, y, angle, length) {
    ...
    var topPercent = 0.1;
    // tail
    var xt = x - length * tailPercent * Math.cos(angle);
    var yt = y - length * tailPercent * Math.sin(angle);
    ...
    // inner top
    var xtop = x + length * topPercent * Math.cos(angle);
    var ytop = y + length * topPercent * Math.sin(angle);
